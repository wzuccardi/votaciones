...
import { Key, RefreshCw, Lock, Unlock, AlertTriangle, CheckCircle } from 'lucide-react'
import { toast } from 'sonner'

interface WitnessPasswordManagerProps {
  leaderId: string
  witnesses: Array<{
    id: string
    voter: {
...
export function WitnessPasswordManager({ 
  leaderId, 
  witnesses,
  onPasswordsUpdated 
}: WitnessPasswordManagerProps) {
  ...
  const loadPasswordStats = async () => {
    try {
      const response = await fetch(`/api/dashboard/leader/witnesses/passwords?leaderId=${leaderId}`)
  ...
  const confirmResetPasswords = async () => {
    ...
    try {
      const response = await fetch('/api/dashboard/leader/witnesses/passwords', {
        method: 'POST',
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Asigna una contraseña estándar para que los testigos puedan acceder al sistema
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-6">
            ...
            <Card className="border-blue-200 bg-blue-50/50">
              <CardHeader>
                ...
                <CardDescription>
                  Esta contraseña se asignará a todos los testigos electorales
                </CardDescription>
              </CardHeader>
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="text-xs text-amber-800">
                      ...
                      <ul className="list-disc list-inside space-y-1">
                        <li>Esta acción actualizará la contraseña de TODOS los testigos</li>
            ...
            <Card>
              ...
              <CardContent className="space-y-2 text-sm text-muted-foreground">
                ...
                <div className="flex gap-2">
                  ...
                  <p>Comparte la contraseña con los testigos antes del día electoral</p>
                </div>
                <div className="flex gap-2">
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="space-y-3">
              <p>
                Estás a punto de asignar la contraseña <span className="font-mono font-bold">"{standardPassword}"</span> a todos los testigos electorales.
              </p>
